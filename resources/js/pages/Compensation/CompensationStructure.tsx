...
const compensationStructureOptions = [
    {
        id: 'fixed',
        name: 'Fixed-pay Centered',
        description: 'Stable base salary with minimal variable components',
        recommended: false,
    },
    {
        id: 'mixed',
        name: 'Fixed + Variable Mix',
        description: 'Balanced combination of base pay and performance bonuses',
        recommended: true,
    },
    {
        id: 'performance_based',
        name: 'Performance-pay Centered',
        description: 'Significant portion tied to individual/team performance',
        recommended: false,
    },
];

export default function CompensationStructure({ company, project }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post(`/step4/${project.id}/compensation-structure`, {
            preserveScroll: true,
        });
    };
    ...
    return (
        <div className="flex h-screen bg-background">
            ...
            <main className="flex-1 overflow-auto md:pt-0 pt-14">
                <Head title="Compensation Structure - Step 4" />
                ...
                <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
                    ...
                    <CompensationProgressBar
                        stepName="Compensation Structure"
                    ...
                    <CompensationTabs
                        tabs={tabs}
                        activeTab="compensation-structure"
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-2xl">Compensation Structure</CardTitle>
                            <p className="text-sm text-muted-foreground mt-2">
                                Select the primary compensation structure for your organization.
                            </p>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid md:grid-cols-3 gap-4">
                                    {compensationStructureOptions.map((option) => {
                                        const isSelected = form.data.compensation_structure === option.id;
                                        return (
                                            <button
                                                key={option.id}
                                                type="button"
                                                onClick={() => form.setData('compensation_structure', option.id)}
