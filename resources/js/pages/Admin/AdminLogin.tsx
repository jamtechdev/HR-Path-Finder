            ...
            <div className="hidden lg:flex lg:w-1/2 lg:flex-shrink-0 flex-col justify-between p-12 text-white relative z-10">
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-1000 delay-200">
                    <div>
                        ...
                        <p className="text-white/80 text-lg max-w-md leading-relaxed">
                            {t('auth.login.admin_subtitle', 'Sign in to access the administration panel and manage your HR system')}
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-white/90">
                            ...
                            <span className="text-sm">{t('auth.login.feature_security', 'Secure Admin Access')}</span>
                        </div>
                        <div className="flex items-center gap-3 text-white/90">
                            <div className="w-8 h-8 rounded-lg bg-success/20 flex items-center justify-center">
                                <Zap className="w-5 h-5 text-success" />
                            </div>
                            <span className="text-sm">{t('auth.login.feature_fast', 'Fast & Reliable')}</span>
                        </div>
                        <div className="flex items-center gap-3 text-white/90">
                            <div className="w-8 h-8 rounded-lg bg-success/20 flex items-center justify-center">
                                <CheckCircle2 className="w-5 h-5 text-success" />
                            </div>
                            <span className="text-sm">{t('auth.login.feature_collaboration', 'Full System Control')}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-8 text-white/60 text-sm animate-in fade-in slide-in-from-left-4 duration-1000 delay-500">
                    <div className="flex items-center gap-2">
                        ...
                        <span>{t('auth.login.trusted', 'Trusted Platform')}</span>
                    </div>
                    <span>•</span>
                    <span>{t('auth.login.consulting_grade', 'Enterprise Grade')}</span>
                </div>
            </div>
                    ...
                    <div className="bg-card border border-border rounded-2xl shadow-xl p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4">
                        ...
                        >
                            <div className="space-y-2">
                                ...
                                />
                                <InputError message={form.errors.email || errors?.email} />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="h-11 w-full transition-all duration-200 focus:ring-2 focus:ring-primary/20 cursor-text"
                                />
                                <InputError message={form.errors.password || errors?.password} />
                            </div>
