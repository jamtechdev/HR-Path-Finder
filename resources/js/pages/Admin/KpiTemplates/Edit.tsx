                    ...
                    <div className="mx-auto max-w-2xl p-6 md:p-8">
                        <div className="mb-6">
                            <Link href="/admin/kpi-templates" className="text-sm text-muted-foreground hover:underline">
                                &larr; {t('admin_kpi_templates_edit.back')}
                            </Link>
                            <h1 className="mt-2 text-3xl font-bold">{t('admin_kpi_templates_edit.heading')}</h1>
                        </div>
                        <form onSubmit={submit}>
                            <Card>
                                <CardHeader>
                                    <CardTitle>{t('admin_kpi_templates_edit.details_title')}</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.company_optional')}</Label>
                                        <select
                                            className="mt-1 w-full rounded-md border border-input bg-background px-3 py-2"
                                            value={data.company_id}
                                            onChange={(e) => setData('company_id', e.target.value)}
                                        >
                                            <option value="">{t('admin_kpi_templates_edit.fields.global')}</option>
                                            {companies.map((c) => (
                                    ...
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.org_unit_optional')}</Label>
                                        <Input
                                    ...
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.kpi_name')}</Label>
                                        <Input
                                            value={data.kpi_name}
                                    ...
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.purpose')}</Label>
                                        <Textarea value={data.purpose} onChange={(e) => setData('purpose', e.target.value)} rows={2} />
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <Label>{t('admin_kpi_templates_edit.fields.category')}</Label>
                                            <Input value={data.category} onChange={(e) => setData('category', e.target.value)} />
                                        </div>
                                        <div>
                                            <Label>{t('admin_kpi_templates_edit.fields.weight')}</Label>
                                            <Input
                                                type="number"
                                                min={0}
                                                max={100}
                                    ...
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.formula')}</Label>
                                        <Input value={data.formula} onChange={(e) => setData('formula', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.measurement_method')}</Label>
                                        <Textarea
                                    ...
                                    <div>
                                        <Label>{t('admin_kpi_templates_edit.fields.sort_order')}</Label>
                                        <Input
                                            type="number"
                                            min={0}
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <Label htmlFor="is_active">{t('admin_kpi_templates_edit.fields.active')}</Label>
                                    </div>
