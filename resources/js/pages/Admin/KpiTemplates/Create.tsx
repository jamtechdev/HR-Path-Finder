    ...
    return (
        <SidebarProvider>
            ...
            <SidebarInset className="flex flex-col overflow-hidden bg-background">
                <AppHeader />
                <Head title="Create KPI Template" />
                <main className="flex-1 overflow-auto bg-background">
                    <div className="mx-auto max-w-2xl p-6 md:p-8">
                        <div className="mb-6">
                            ...
                            <h1 className="mt-2 text-3xl font-bold">Create KPI Template</h1>
                        </div>
                        <form onSubmit={submit}>
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div>
                                        <Label>Company (optional – leave empty for global)</Label>
                                        <select
                                    ...
                                    <div>
                                        <Label>Org unit name (optional – leave empty for company-wide)</Label>
                                        <Input
