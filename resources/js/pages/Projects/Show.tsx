        ...
        <SidebarProvider defaultOpen={true}>
            ...
            <SidebarInset className="flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-auto">
                    <Head
                        title={`${project.company.name} - ${t('admin_hr_project_details.page_title')}`}
                    />
                    ...
                    <div className="mx-auto max-w-7xl p-6 md:p-8">
                        <div className="mb-6">
                            <Link href={projectsListPath}>
                                <Button variant="ghost" className="mb-4">
                                    ...
                                    {t(
                                        'admin_hr_project_details.back_to_projects',
                                    )}
                                </Button>
                            </Link>
                        ...
                        <Card className="mb-6">
                            <CardHeader>
                                <CardTitle>
                                    {t(
                                        'admin_hr_project_details.project_status',
                                    )}
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                        ...
                        <div className="grid gap-4">
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        {t(
                                            'admin_hr_project_details.workflow_steps',
                                        )}
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                        ...
                                        {steps.map((step) => (
                                            ...
                                            >
                                                ...
                                                <span className="text-sm text-muted-foreground capitalize">
                                                    {step.status ||
                                                        t(
                                                            'admin_hr_project_details.not_started',
                                                        )}
                                                </span>
                                            </div>
                                        ))}
                            ...
                            {project.diagnosis && (
                                <Card>
                                    <CardHeader>
                                        <CardTitle>
                                            {t(
                                                'admin_hr_project_details.quick_actions',
                                            )}
                                        </CardTitle>
                                    </CardHeader>
                                        ...
                                        {isAdmin ? (
                                            <>
                                                ...
                                                >
                                                    <Button>
                                                        {t(
                                                            'admin_hr_project_details.review_project',
                                                        )}
                                                    </Button>
                                                </Link>
                                                <Link
                                                    href={`/admin/hr-system/${project.id}`}
                                                >
                                                    <Button variant="outline">
                                                        {t(
                                                            'admin_hr_project_details.view_overview',
                                                        )}
                                                    </Button>
                                                </Link>
                                            </>
                                            ...
                                            <>
                                                <Link
                                                    href={`/hr-manager/diagnosis/${project.id}/overview`}
                                                >
                                                    <Button>
                                                        {t(
                                                            'admin_hr_project_details.continue_diagnosis',
                                                        )}
                                                    </Button>
                                                </Link>
                                                <Link
                                                    href={`/hr-system/${project.id}`}
                                                >
                                                    <Button variant="outline">
                                                        {t(
                                                            'admin_hr_project_details.view_overview',
