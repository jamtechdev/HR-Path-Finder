...
export default function Contact() {
    ...
    return (
        <>
            <Head title={t('landing_contact_page.page_title')} />
            <LandingNav />
            <Toaster />
                        ...
                        <div className="px-6 py-6 border-b border-white/10">
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <span className="text-xs font-bold uppercase tracking-[0.14em] text-[#2ECFAB]">
                                    {t('landing_contact_page.form_kicker')}
                                </span>
                            </div>
                        </div>
                        ...
                        >
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <label className="space-y-2 block">
                                    <div className="text-xs font-semibold text-white/70">{t('landing_contact_page.company_name')}</div>
                                    <input
                                        ...
                                        placeholder={t('landing_contact_page.company_placeholder')}
                                        required
                                    />
                                ...
                                <label className="space-y-2 block">
                                    <div className="text-xs font-semibold text-white/70">{t('landing_contact_page.manager_name')}</div>
                                    <input
                                        value={data.manager_name}
                                        onChange={(e) => setData('manager_name', e.target.value)}
                                        className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none focus:ring-2 focus:ring-[#2ECFAB]/40"
                                        placeholder={t('landing_contact_page.manager_placeholder')}
                                        required
                                    />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <label className="space-y-2 block">
                                    <div className="text-xs font-semibold text-white/70">{t('landing_contact_page.email')}</div>
                                    <input
                                        value={data.manager_email}
                                        onChange={(e) => setData('manager_email', e.target.value)}
                                        type="email"
                                        className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none focus:ring-2 focus:ring-[#2ECFAB]/40"
                                        placeholder={t('landing_contact_page.email_placeholder')}
                                        required
                                    />
                                ...
                                <label className="space-y-2 block">
                                    <div className="text-xs font-semibold text-white/70">{t('landing_contact_page.phone_optional')}</div>
                                    <input
                                        value={data.phone}
                                        onChange={(e) => setData('phone', e.target.value)}
                                        className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none focus:ring-2 focus:ring-[#2ECFAB]/40"
                                        placeholder={t('landing_contact_page.phone_placeholder')}
                                    />
                            ...
                            <label className="space-y-2 block">
                                <div className="text-xs font-semibold text-white/70">{t('landing_contact_page.inquiry')}</div>
                                <textarea
                                    value={data.inquiry}
                                    onChange={(e) => setData('inquiry', e.target.value)}
                                    rows={6}
                                    className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none focus:ring-2 focus:ring-[#2ECFAB]/40"
                                    placeholder={t('landing_contact_page.inquiry_placeholder')}
                                    required
                                />
                            ...
                            <label className="flex items-start gap-3 pt-1">
                                ...
                                <span className="text-xs text-white/70 leading-relaxed">
                                    {t('landing_contact_page.privacy_agree')}
                                </span>
                            </label>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between pt-2">
                                <p className="text-xs text-white/60 leading-relaxed">
                                    {t('landing_contact_page.footer_note')}
                                </p>
                                <button
                                    type="submit"
                                    disabled={processing}
                                ...
                                >
                                    {processing ? t('landing_contact_page.submitting') : t('landing_contact_page.submit')}
                                </button>
                            </div>
                        </form>
                    </div>
