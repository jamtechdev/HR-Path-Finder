...
export default function CeoCompensationReview({ 
    ...
    return (
        <AppLayout>
            <Head title={t('ceo_review_compensation.page_title', { company: project.company.name })} />
                    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl sm:max-w-6xl lg:max-w-7xl mx-auto min-h-screen">
                        <div className="mb-4 sm:mb-6">
                            ...
                            >
                                ...
                                {t('ceo_review_compensation.back_to_dashboard')}
                            </Button>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                                <h1 className="text-2xl sm:text-3xl font-bold dark:text-slate-100 leading-tight">{t('ceo_review_compensation.heading')}</h1>
                                <Badge variant={isSubmitted ? 'default' : 'secondary'} className="text-xs sm:text-sm">
                                    {isSubmitted ? t('ceo_review_compensation.status.submitted') : compensationStatus}
                                </Badge>
                            </div>
                            <p className="text-sm sm:text-base text-muted-foreground dark:text-slate-400 leading-relaxed">
                                {t('ceo_review_compensation.subheading', { company: project.company.name })}
                            </p>
                        </div>
                                ...
                                <CardContent className="p-4 sm:p-6">
                                    <div className="flex items-start gap-2 sm:gap-3">
                                        ...
                                        <p className="text-sm text-yellow-800 dark:text-yellow-200 leading-relaxed">
                                            {t('ceo_review_compensation.not_submitted_yet')}
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                        ...
                        {compensationSystem && (
                            <div className="space-y-6">
                                ...
                                <Card className="dark:bg-slate-800 dark:border-slate-700">
                                    <CardHeader className="dark:bg-slate-800">
                                        <CardTitle className="flex items-center gap-2 dark:text-slate-100">
                                            ...
                                            {t('ceo_review_compensation.sections.compensation_structure')}
                                        </CardTitle>
                                    </CardHeader>
                                    <CardContent className="dark:bg-slate-800 p-4 sm:p-6">
                                        <div className="space-y-1 sm:space-y-2">
                                            <p className="text-xs sm:text-sm text-muted-foreground dark:text-slate-400">{t('ceo_review_compensation.fields.selected_structure')}</p>
                                            <p className="text-base sm:text-lg font-semibold dark:text-slate-200">
                                                {compensationSystem.compensation_structure 
                                                    ...
                                                    : t('ceo_review_compensation.fields.not_specified')}
                                            </p>
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="dark:bg-slate-800 dark:border-slate-700">
                                    <CardHeader className="dark:bg-slate-800">
                                        <CardTitle className="dark:text-slate-100">{t('ceo_review_compensation.sections.differentiation_method')}</CardTitle>
                                    </CardHeader>
                                    <CardContent className="dark:bg-slate-800 p-4 sm:p-6">
                                        <div className="space-y-1 sm:space-y-2">
                                            <p className="text-xs sm:text-sm text-muted-foreground dark:text-slate-400">{t('ceo_review_compensation.fields.selected_method')}</p>
                                            <p className="text-base sm:text-lg font-semibold dark:text-slate-200">
                                ...
                                <Card className="dark:bg-slate-800 dark:border-slate-700">
                                    <CardHeader className="dark:bg-slate-800">
                                        <CardTitle className="dark:text-slate-100">{t('ceo_review_compensation.sections.incentive_components')}</CardTitle>
                                    </CardHeader>
                                        <CardContent className="dark:bg-slate-800 p-4 sm:p-6">
                                            <div className="space-y-2">
                                                <p className="text-xs sm:text-sm text-muted-foreground dark:text-slate-400 mb-2 sm:mb-3">{t('ceo_review_compensation.fields.selected_components')}</p>
                                                {compensationSystem.incentive_types && compensationSystem.incentive_types.length > 0 ? (
                                                    ...
                                                    <p className="text-xs sm:text-sm text-muted-foreground dark:text-slate-400">{t('ceo_review_compensation.fields.no_incentive_components')}</p>
                                                )}
                                            </div>
                                        </CardContent>
                                </Card>
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-4">
                                                <div className="sm:text-right">
                                                    <h3 className="font-semibold mb-1 text-base sm:text-lg dark:text-slate-100">{t('ceo_review_compensation.actions.title')}</h3>
                                                    <p className="text-sm text-muted-foreground dark:text-slate-400 leading-relaxed">
                                                        {t('ceo_review_compensation.actions.description')}
                                                    </p>
                                                </div>
                                                <div className="flex flex-wrap gap-2 sm:gap-3">
                                                    ...
                                                    >
                                                        ...
                                                        {t('ceo_review_compensation.actions.request_revision')}
                                                    </Button>
                                                    <Button
                                                    ...
                                                    >
                                                        ...
                                                        {t('ceo_review_compensation.actions.approve_and_lock')}
                                                    </Button>
                                                </div>
                                            </div>
                                        </CardContent>
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <p className="text-yellow-800 dark:text-yellow-200">
                                                    {t('ceo_review_compensation.pending_submission_notice')}
                                                </p>
                                            </div>
                                        </CardContent>
                                    </Card>
