                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="w-full"
                                        onClick={() => window.open(`/ceo/report/${projectId}/download/diagnosis`, '_blank')}
                                    >
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="w-full"
                                        onClick={() => window.open(`/ceo/report/${projectId}/download/job_analysis`, '_blank')}
                                    >
                                        <Download className="w-4 h-4 mr-2" />
                                        Download Report (PDF)
                                    </Button>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="w-full"
                                        onClick={() => window.open(`/ceo/report/${projectId}/download/performance`, '_blank')}
                                    >
                                        <Download className="w-4 h-4 mr-2" />
                                        Download Report (PDF)
                                    </Button>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="w-full"
                                        onClick={() => window.open(`/ceo/report/${projectId}/download/compensation`, '_blank')}
                                    >
                                        <Download className="w-4 h-4 mr-2" />
                                        Download Report (PDF)
                                    </Button>
