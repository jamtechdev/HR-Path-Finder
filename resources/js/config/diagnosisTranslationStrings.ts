/**
 * Plain EN/KO strings for HR Diagnosis (no i18n import — safe to register with i18next).
 */
export const diagnosisTranslationStrings = {
    // Common
    back: { en: 'Back', ko: '이전' },
    next: { en: 'Next', ko: '다음' },
    ...
    completeRequired: {
        en: 'Complete required fields to continue',
        ko: '필수 항목을 입력한 후 진행해 주세요.',
    },
    ...
    expectedRoleCompetencies: {
        en: 'Expected Role & Competencies',
        ko: '기대역할 및 역량',
    },
    ...
    noStructureSelected: {
        en: 'No organizational structure selected',
        ko: '선택된 조직 구조가 없습니다',
    },
    ...
    customIssuePlaceholder: {
        en: 'Enter any HR issues not listed above…',
        ko: '위 항목에 없는 HR 이슈를 자유롭게 입력하세요…',
    },
    ...
    leaderRatioLabel: {
        en: 'Leader ratio (managers + executives)',
        ko: '리더 비중 (관리자+임원)',
    },
    executiveRatioLabel: { en: 'Executive ratio', ko: '임원 비중' },
    executiveHeadcountLabel: { en: 'Executive headcount', ko: '임원 인원' },
    leaderHeadcountLabel: {
        en: 'Leader headcount (excl. executives)',
        ko: '리더 인원 (임원 제외)',
    },
    ...
    companyCardTitle: { en: 'Company', ko: '회사' },
    workforceCardTitle: { en: 'Workforce', ko: '인력' },
    gradePyramidTitle: { en: 'Headcount by job grade', ko: '직급별 인원 분포' },
    currentOrgChartTitle: { en: 'Current org chart', ko: '현재 조직도' },
    orgStructureCardTitle: { en: 'Org Structure', ko: '조직 구조' },
    ...
    submitConfirmTitle: {
        en: 'Have you checked all contents?',
        ko: '모든 내용을 확인하셨나요?',
    },
    submitConfirmDesc: {
    ...
    workforceHeroDesc: {
        en: 'Enter total headcount and gender composition.',
        ko: '현재 재직 중인 전체 인원과 성별 구성을 입력하세요',
    },
    ...
    genderMismatchWarn: {
        en: 'Male + Female total does not match present headcount.',
        ko: '남성+여성 합계가 전체 재직 인원과 다릅니다',
    },
    includeAllHint: {
        en: '** Include full-time, contract, and dispatched employees. **Exclude executives.**',
        ko: '** 정규직·계약직·파견직을 모두 포함합니다. **임원은 제외합니다.**',
    },
    workforceFullTimeLabel: { en: 'Full-time', ko: '정규직' },
    workforceContractLabel: { en: 'Contract', ko: '계약직' },
    workforceTotalLabel: { en: 'Total', ko: '합계' },
    ...
    forecastCardDesc: {
        en: 'Enter expected headcount for the next 1–3 years.',
        ko: '향후 1-3년 예상 재직 인원을 입력하세요',
    },
    ...
    companyInfoHeroDesc: {
        en: 'Enter company identification, industry, and HQ location.',
        ko: '회사 식별 정보, 산업, 위치 정보를 입력하세요.',
    },
    ...
    brandNamePlaceholder: {
        en: 'Displayed brand or trade name (optional)',
        ko: '표시용 브랜드명(선택)',
    },
    ...
    logoUploadHint: {
        en: 'Drag & drop or click to choose a file',
        ko: '드래그 앤 드롭 또는 클릭하여 파일 선택',
    },
    logoUploadSpec: {
        en: 'PNG · JPG · max 2MB · recommended 400×400px',
        ko: 'PNG · JPG · 최대 2MB · 권장 400x400px',
    },
    chooseFileBtn: { en: 'Choose file', ko: '파일 선택' },
    logoAlt: { en: 'Company logo', ko: '회사 로고' },
    fileTypeError: {
        en: 'Please upload a PNG or JPG image file.',
        ko: 'PNG 또는 JPG 이미지 파일을 업로드해 주세요.',
    },
    fileSizeError: {
        en: 'File size must be less than 2MB.',
        ko: '파일 용량은 2MB 이하여야 합니다.',
    },
    saveDraft: { en: 'Save draft', ko: '임시 저장' },
    saveDraftHint: {
        en: 'Draft is saved in this browser for this project.',
        ko: '이 브라우저에서 해당 프로젝트용 초안으로 저장됩니다.',
    },
    completionTitle: { en: 'Completion', ko: '완료도' },
    completionDescription: {
        en: 'Fill all required fields (marked *) to reach 100%.',
        ko: '필수 항목(*)을 모두 입력하면 100%가 됩니다.',
    },

    // Diagnosis Submit Success Modal
    diagnosisSubmitSuccessTitle: {
...
export type DiagnosisTranslationKey = keyof typeof diagnosisTranslationStrings;
